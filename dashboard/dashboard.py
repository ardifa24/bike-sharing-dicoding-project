...
st.subheader("tren jumlah penyewaan sepeda dalam beberapa tahun terakhir ")
...
st.subheader("Pada jam berapa penyewaan sepeda mencapai jumlah tertinggi dan terendah?")
...
st.subheader("Pada musim apa volume penyewaan sepeda mencapai puncaknya?")
